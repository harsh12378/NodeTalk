...
export default function Friends() {
    ...
    const fetchFriends = async () => {
      ...
      try {
        ...
        if (response.status === 200) {
          // Sort friends by lastMessageAt (most recent first)
  ...
  return (
    <div>
      <div className="  w-full m-0 " style={{ boxSizing: "border-box" }}>
        {loading && (
          <div className="flex flex-col items-center justify-center py-8">
            <svg
              className="w-8 h-8 animate-spin text-green-500 mb-2"
              fill="none"
              viewBox="0 0 24 24"
            >
              <circle
            ...
            <p className="text-base text-green-400 font-semibold tracking-wide drop-shadow-sm">
              Loading friends...
            </p>
          </div>
        )}
        ...
        {!loading && friends.length === 0 && (
          <div className="flex flex-col items-center justify-center py-8">
            ...
            <p className="text-base text-red-400 font-semibold tracking-wide drop-shadow-sm">
              No friends found.
            </p>
          </div>
        )}
      ...
      <div
        className="flex flex-col w-full m-0 p-0 px-0 bg-gray-900 min-h-[calc(100vh-164px)] "
